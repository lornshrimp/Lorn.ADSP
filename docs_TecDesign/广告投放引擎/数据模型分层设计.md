...
classDiagram
    ...
    class AdContext {
        ...
        +IsFromTargetRegion(GeoLocation target) bool
    ...
    AdContext "1" o-- "0..1" UserProfile : references
    UserProfile "1" o-- "0..*" AdCandidate : influences
```
