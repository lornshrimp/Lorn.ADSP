...
classDiagram
    ...
    class TargetingConfig {
        ...
        +DateTime UpdatedAt
        +string CreatedFrom
        +CreateFromPolicy(TargetingPolicy policy) TargetingConfig
    ...
    AdCandidate "1" o-- "1" TargetingConfig : has
    ...
    TargetingConfig "1" o-- "1" TargetingPolicy : derived_from
    OverallMatchResult "1" o-- "1" TargetingContext : evaluated_against
```
