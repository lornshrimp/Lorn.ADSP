...
public class ComponentConventionRule
{
    ...
    public Type[] RequiredInterfaces { get; set; } = Array.Empty<Type>();
...
public static class ComponentConventions
{
    private static readonly List<ComponentConventionRule> _conventionRules = new()
    {
        new ComponentConventionRule
        {
            ...
            RequiredInterfaces = new[] { typeof(IAdProcessingStrategy) },
        ...
        new ComponentConventionRule
        {
            ...
            RequiredInterfaces = Array.Empty<Type>(),
        ...
        new ComponentConventionRule
        {
            ...
            RequiredInterfaces = new[] { typeof(IDataAccessProvider) },
            ConfigurationPathTemplate = "DataProviders:{0}",
            Description = "数据访问提供者组件"
        },
        new ComponentConventionRule
        {
            Suffix = "CallbackProvider",
            Lifetime = ServiceLifetime.Singleton,
            RequiredInterfaces = new[] { typeof(ICallbackProvider) },
            ConfigurationPathTemplate = "Callbacks:{0}",
            Description = "回调提供者组件"
        },
        new ComponentConventionRule
        {
            Suffix = "Matcher",
            Lifetime = ServiceLifetime.Transient,
            RequiredInterfaces = new[] { typeof(ITargetingMatcher) },
            ConfigurationPathTemplate = "Targeting:{0}",
            Description = "定向匹配器组件"
        },
        new ComponentConventionRule
        {
    ...
    {
        return _conventionRules.FirstOrDefault(rule => 
            type.Name.EndsWith(rule.Suffix) &&
            (rule.RequiredInterfaces.Length == 0 || 
             rule.RequiredInterfaces.Any(interfaceType => interfaceType.IsAssignableFrom(type))));
    }
    ...
    public static string GetConfigurationPath(Type type)
    {
        ...
        var componentName = type.Name.Replace(rule.Suffix, "");
