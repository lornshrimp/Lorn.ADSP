...
namespace Lorn.ADSP.DE.AdFilters.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class TestAdLocationAdFilter
    {
        public TestAdLocationAdFilter()
        {
            //
            //TODO:  在此处添加构造函数逻辑
            //
        ...
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", @"AdLocationAdFilterTests.csv", "AdLocationAdFilterTests#csv", DataAccessMethod.Sequential), TestMethod()]
